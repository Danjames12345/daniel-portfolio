...
import AboutImage from '../assets/abin.jpg'
function About() {
  return (
        ...
        <div className='container mx-auto px-8 md:px-16 lg:px-24'>
            ...
            <div className='flex flex-col md:flex-row items-center md:space-x-12'>
                ...
                <p className=' text-lg mb-9'>
                    I am a passionate full-stack developer with a focus on building  modern and responsive web application. with a strong foundation in both frontend and backend technologies, i strive to create seamless and efficient user experience
                </p>
